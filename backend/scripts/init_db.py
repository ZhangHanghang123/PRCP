...
DDLS = [
    ...
    CREATE TABLE IF NOT EXISTS prcp_data_basic (
      ...
      -- 原始期限金额（64 个期限桶：5年内按月 m1~m60 + 长端 y10/y15/y20/y30）
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='基础数据表（账户册+日期+偏移量，64+64 期限桶：5年内按月 m1~m60 + 长端 y10/y15/y20/y30）'
    """,
    # ===== 指标管理 =====
    """
