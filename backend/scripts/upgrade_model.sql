...
-- 种子数据：3 个示例模型
INSERT INTO prcp_model (model_code, model_name, model_type, biz_domain, description, status, created_by)
VALUES
...
-- 种子数据：每个模型一个 V1_BASELINE 版本
INSERT INTO prcp_model_version (model_id, version_code, version_name, description, status, created_by)
SELECT m.id, 'V1_BASELINE', '基准情景', '初始基准参数配置', 'READY', 1
FROM prcp_model m WHERE m.is_deleted=0;