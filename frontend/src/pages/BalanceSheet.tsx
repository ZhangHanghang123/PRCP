...
const MEASURES = [
  { key: 'begin_balance',   name: '月初余额',     width: 48, color: '#595959', precision: 2, isPercent: false },
  { key: 'current_amount',  name: '月末余额',     width: 52, color: '#cf1322', precision: 2, isPercent: false },
  { key: 'avg_balance',     name: '平均余额',     width: 48, color: '#1d39c4', precision: 2, isPercent: false },
  { key: 'interest_rate',   name: '利率(%)',     width: 48, color: '#fa8c16', precision: 4, isPercent: true  },
  { key: 'interest_amount', name: '利息收支',     width: 36, color: '#722ed1', precision: 2, isPercent: false },
  { key: 'capital_ratio',   name: '资本占用(%)', width: 47, color: '#13c2c2', precision: 4, isPercent: true  },
          ...
          items={[
            {
              ...
              children: (
                <Table
                  ...
                  scroll={{ x: 60 + 200 + 50 + matrixDates.length * 7 * 110 + 80, y: 'calc(100vh - 380px)' }}
                  pagination={false}
                  bordered
